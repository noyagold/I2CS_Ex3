...
public class GameInfo {
	public static final String MY_ID = "325483410";
	...
	//private static PacManAlgo _manualAlgo = new ManualAlgo();//manual
	private static PacManAlgo _myAlgo = new Ex3Algo();//my algorithem
